package com.mm.engine.framework.control.aop;
...
//    private static Map<Class<?>,Object> proxyClassMap=new HashMap<Class<?>,Object>();
...
//                System.out.println("target class:"+cls+"---------,aspect:"+aspect);
