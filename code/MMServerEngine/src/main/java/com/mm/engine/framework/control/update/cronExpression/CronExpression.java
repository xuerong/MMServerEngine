...
public final class CronExpression implements Serializable, Cloneable {
    ...
    protected void buildExpression(String expression) throws ParseException {
        ...
        try {
            ...
            for(StringTokenizer exprsTok = new StringTokenizer(expression, " \t", false); exprsTok.hasMoreTokens() && e <= 6; ++e) {
                ...
                if(e == 3 && dow.indexOf(76) != -1 && dow.length() > 1 && dow.contains(",")) {
                    throw new ParseException("Support for specifying \'L\' and \'LW\' with other days of the month is not implemented", -1);
                }

                if(e == 5 && dow.indexOf(76) != -1 && dow.length() > 1 && dow.contains(",")) {
                    throw new ParseException("Support for specifying \'L\' with other days of the week is not implemented", -1);
                }

                if(e == 5 && dow.indexOf(35) != -1 && dow.indexOf(35, dow.indexOf(35) + 1) != -1) {
    ...
    protected int storeExpressionVals(int pos, String s, int type) throws ParseException {
        ...
        if(i >= s.length()) {
            ...
            char c = s.charAt(i);
            if(c >= 65 && c <= 90 && !s.equals("L") && !s.equals("LW") && !s.matches("^L-[0-9]*[W]?")) {
                String var15 = s.substring(i, i + 3);
                boolean var14 = true;
                int eval = -1;
                int var16;
                if(type == 4) {
                    ...
                    if(var16 <= 0) {
                        throw new ParseException("Invalid Month value: \'" + var15 + "\'", i);
                    }
                    ...
                    if(s.length() > i + 3) {
                        ...
                        if(c == 45) {
                            i += 4;
                            var15 = s.substring(i, i + 3);
                            eval = this.getMonthNumber(var15) + 1;
                            if(eval <= 0) {
                                throw new ParseException("Invalid Month value: \'" + var15 + "\'", i);
                            }
                        }
                    ...
                    if(type != 5) {
                        throw new ParseException("Illegal characters for this position: \'" + var15 + "\'", i);
                    }

                    var16 = this.getDayOfWeekNumber(var15);
                    if(var16 < 0) {
                        throw new ParseException("Invalid Day-of-Week value: \'" + var15 + "\'", i);
                    }
                    ...
                    if(s.length() > i + 3) {
                        ...
                        if(c == 45) {
                            i += 4;
                            var15 = s.substring(i, i + 3);
                            eval = this.getDayOfWeekNumber(var15);
                            if(eval < 0) {
                                throw new ParseException("Invalid Day-of-Week value: \'" + var15 + "\'", i);
                            }
                        } else if(c == 35) {
                ...
                this.addToSet(var16, eval, incr, type);
                return i + 3;
            } else {
                int val;
                if(c == 63) {
                    ...
                    if(c == 76) {
                        ...
                        if(type == 3 && s.length() > i) {
                            c = s.charAt(i);
                            if(c == 45) {
                                ValueSet var13 = this.getValue(0, s, i + 1);
    ...
    protected ValueSet getValue(int v, String s, int i) {
        ...
        StringBuilder s1;
        for(s1 = new StringBuilder(String.valueOf(v)); c >= 48 && c <= 57; c = s.charAt(i)) {
            s1.append(c);
            ++i;
            if(i >= s.length()) {
                break;
                        ...
                        if(hr == var19) {
                            ...
                            if(dayOfMSpec && !dayOfWSpec) {
                                ...
                                if(this.lastdayOfWeek) {
                                    ...
                                    st = this.daysOfWeek.tailSet(Integer.valueOf(year));
                                    if(st != null && st.size() > 0) {
