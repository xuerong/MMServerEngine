 ...
 */
public class SceneNettyDecoder extends ByteToMessageDecoder {
    ...
    protected void decode(ChannelHandlerContext ctx, ByteBuf in, List<Object> list) throws Exception {
        ...
        SceneNetData sceneNetData = new SceneNetData();
        sceneNetData.setSceneId(sceneId);
        sceneNetData.setOpcode(opcode);
        sceneNetData.setData(bbb);

        // add之后好像in就被重置了
        list.add(sceneNetData);
        // 清理临时变量
        size = headSize;
        isReadHead = false;
    }
